...
<?php endif; ?>
<form method="POST" action="index.php?page=admin&controller=tacgia&action=edit&id=<?php echo $tacgia['id']; ?>" class="user-form">
    <table>
        <tr>
        ...
        <tr>
            <td>
                <input type="text" 
                       id="ten_tacgia" 
                       name="ten_tacgia" 
                       value="<?php echo htmlspecialchars($tacgia['ten_tacgia']); ?>"
                       required
        ...
        <tr>
            <td>
                <input type="text" 
                       id="but_danh" 
                       name="but_danh" 
                       value="<?php echo htmlspecialchars($tacgia['but_danh']); ?>"
        ...
        <tr>
            <td>
                <textarea id="gioi_thieu" 
                          ...
                          style="width: 100%; padding: 9px 12px; border: 1px solid #ccc; border-radius: 6px; font-size: 14px; font-family: 'Segoe UI', Tahoma, Arial, sans-serif; resize: vertical;"><?php echo htmlspecialchars($tacgia['gioi_thieu']); ?></textarea>
            </td>
        </tr>
    </table>
